...
# 📂 Upload File
uploaded_file = st.file_uploader("📂 Upload File Excel", type=".xlsx", help="Pastikan file yang diunggah dalam format .xlsx dengan data kurs jual rupiah.")
...
with st.sidebar.subheader("📌 Data yang Diupload"):
    st.sidebar.dataframe(df, width=2000, height=400)
